...
namespace Cliente
{
    class Cliente
    {
        ...
        static void Main(string[] args)
        {
            ...
            new Thread(() => HandleServer(networkDataHelper)).Start();
        ...
        static void HandleServer(NetworkDataHelper networkDataHelper)
        {
            while (connected)
            {
